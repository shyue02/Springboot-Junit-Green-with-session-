...
public class ProductDaoTest {
    ...
    // Junit은 메소드 실행직전에 트랜젝션이 걸리고, 메소드 실행이 끝나면 rollback 됨
    ...
    public void insert_test() {
        ...
        Product product = new Product(productName, productPrice, productQty); // 일관성있게
    ...
    public void update_test() {
        ...
        // when
        // product [id=1, productNmae="수박", productPrice=1000, productQty=100]
